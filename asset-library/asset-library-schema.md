...
CREATE TABLE assets (
  ...
  base_name       TEXT,                   -- weight-stripped name: heart-fill → heart
...
GET /v1/assets?q=heart              (searches name, slug, and base_name)
GET /v1/assets?source=phosphor
GET /v1/assets?base_name=heart      (all weight variants of heart)
GET /v1/assets?base_name=heart&tag=duotone  (just the duotone variant)
