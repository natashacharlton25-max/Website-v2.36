...
### Decision: Core atoms plus supporting atoms, used everywhere

The entire site — across all three brands (Mind the Box, Be You Love Wins, Frequency) — is built from a core set of atoms. Ten primary atoms handle content, plus supporting atoms for effects, feedback, and layout:
...
## 16. Brand System: Same Atoms, Different Tokens
...
## 17. Workbook + Scrollytelling: Two Compositions, Same Content
...
## 18. Content Pipeline: JSON Describes, System Renders
...
## 19. The "Your View" Panel: User Preferences, Not Disability Accommodations
