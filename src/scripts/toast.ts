...
const themeLottieUrls: Record<string, string> = {
  arcade: '/Animated Icons/Toast Icons/Activity/activity.json',
  professional: '/Animated Icons/Toast Icons/NotificationV3/notification-V3.json',
  brutalist: '/Animated Icons/Toast Icons/Alert triangle/alertTriangle.json',
  glass: '/Animated Icons/Toast Icons/Info/info.json',
  neon: '/Animated Icons/Toast Icons/Thumb up/thumbUp.json'
};
