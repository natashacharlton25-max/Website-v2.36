...
**Files scanned:** 373
**Files with colour findings:** 196

## Summary

| Metric | Count |
|--------|-------|
| Colour token definitions | 1450 |
| Unique colour tokens defined | 481 |
| Token usages (var references) | 8164 |
| Unique tokens referenced | 461 |
| Hardcoded colour values | 1185 |
| Unique hardcoded values | 351 |
| Inline styles with colours | 24 |
| Tokens defined but NEVER used | 319 |
...
|-------------|------------|-------|-----------------|
| `white` | 223 | 63 | Create new token — used frequently |
| `#ffffff` | 64 | 20 | Replace with `var(--text)` |
| `black` | 34 | 14 | Create new token — used frequently |
| `#333333` | 34 | 8 | Replace with `var(--a11y-mono-c-text)` |
| `#8fa68a` | 26 | 13 | Replace with `var(--color-Primary-500)` |
...
| `#777777` | 5 | 4 | Replace with `var(--color-Text-600)` |
...
| `#e0dedb` | 3 | 2 | Replace with `var(--color-Neutral-200)` |
| `#556a50` | 3 | 2 | Replace with `var(--color-Primary-700)` |
...
| `#393531` | 3 | 2 | Replace with `var(--color-Neutral-800)` |
...
| `#262626` | 2 | 2 | Replace with `var(--color-Text-950)` |
...
| `#ddd9d3` | 2 | 2 | Replace with `var(--a11y-cream-c-bg)` |
| `#8b7355` | 2 | 2 | Replace with `var(--a11y-cream-c-primary)` |
| `#6b8e7a` | 2 | 2 | Replace with `var(--a11y-cream-c-accent)` |
...
| `#cee6c8` | 1 | 1 | Replace with `var(--color-Primary-300)` |
...
| `#ffcfba` | 1 | 1 | Replace with `var(--color-Secondary-300)` |
| `#e5af9a` | 1 | 1 | Replace with `var(--color-Secondary-400)` |
| `#a4725f` | 1 | 1 | Replace with `var(--color-Secondary-600)` |
| `#855543` | 1 | 1 | Replace with `var(--color-Secondary-700)` |
...
| `#c2bdb8` | 1 | 1 | Replace with `var(--color-Neutral-300)` |
...
| `#262626` | `--color-Text-800`, `--color-Text-950` |
...
| `#777777` | `--a11y-mono-c-accent`, `--a11y-monochrome-c-accent`, `--color-Text-600` |
...
| `#c4907c` | `--brand-c-accent`, `--brand-secondary`, `--color-Secondary-500` |
...
| `#ffffff` | `--a11y-hc-c-text`, `--a11y-high-contrast-c-text`, `--color-Primary-500`, `--color-Text-300`, `--color-Text-400`, `--color-Text-500`, `--color-Text-600`, `--color-Text-700`, `--color-Text-800`, `--color-Text-900`, `--color-Text-950`, `--color-White`, `--linkHover`, `--text`, `--textMuted` |
...
|-------------|-----------------|---------------------|
| `#8fa68a` | 361 | candidate-1 |
| `#faf8f7` | 264 | candidate-2 |
| `#ffffff` | 255 | candidate-3 |
| `0.75rem` | 243 | candidate-4 |
| `white` | 223 | candidate-5 |
| `0.875rem` | 208 | candidate-6 |
| `#71876c` | 173 | candidate-7 |
| `#5a5a5a` | 153 | candidate-8 |
| `#777777` | 143 | candidate-9 |
| `1rem` | 141 | candidate-10 |
| `1.125rem` | 98 | candidate-11 |
| `#556a50` | 94 | candidate-12 |
| `#373737` | 76 | candidate-13 |
| `#949494` | 74 | candidate-14 |
| `1.25rem` | 73 | candidate-15 |
| `1.5rem` | 68 | candidate-16 |
| `#e0dedb` | 58 | candidate-17 |
| `#333333` | 58 | candidate-18 |
| `#474747` | 56 | candidate-19 |
| `#c4907c` | 55 | candidate-20 |

---

## ✅ Recommendations

1. **Tokenise 1185 hardcoded colour values** across 104 files. Start with the most frequently used values and the worst-offending files listed above.

2. **Remove 319 unused token definitions** to reduce dead code and confusion about which tokens are active.

3. **Move 24 inline colour styles** to CSS classes using tokens for consistency and maintainability.

4. **Consolidate 64 duplicate colour values** into shared base tokens following the ally pattern.
